...
output_folder = os.path.join(input_folder, "C:/Users/Karina/Dropbox/Fondecyt1221210/Fotografias y videos/Loco- Empaq CT etapa 4 Fotos cortadas/Contadas/CT065-D0")
...
csv_path = os.path.join(output_csv_folder, "CT059-D0.csv")

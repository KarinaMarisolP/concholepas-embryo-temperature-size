...
| `embriones_por_vol_estd` | Standardized embryo density using a scaling exponent |
...
- Missing values (`NA`) are expected and reflect the experimental design.
